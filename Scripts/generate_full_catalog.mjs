...
const DIES_APRI_REPLACEMENT_TRACKS = [
  { title: "Bargain in Ruins [ IV ]", file: "Bargain in Ruins [ IV ].web.m4a", art: "Bargain in Ruins [ IV ].png" },
  { title: "Bargain in Ruins [ V ] 110 BPM", file: "Bargain in Ruins [ V ] 110 BPM.web.m4a", art: "Bargain in Ruins [ V ] 110 BPM.png" },
  { title: "God Only Knows [ I ]", file: "God Only Knows [ I ].web.m4a", art: "God Only Knows [ I ].png" },
  { title: "God Only Knows [ II ]", file: "God Only Knows [ II ].web.m4a", art: "God Only Knows [ II ].png" },
  { title: "God Only Knows [ III ]", file: "God Only Knows [ III ].web.m4a", art: "God Only Knows [ III ].png" },
  { title: "God Only Knows [ IV ]", file: "God Only Knows [ IV ].web.m4a", art: "God Only Knows [ IV ].png" },
  { title: "God Only Knows [ V ]", file: "God Only Knows [ V ].web.m4a", art: "God Only Knows [ V ].png" },
  { title: "God Only Knows [ VI ]", file: "God Only Knows [ VI ].web.m4a", art: "God Only Knows [ VI ].png" },
  { title: "God Only Knows [ VII ]", file: "God Only Knows [ VII ].web.m4a", art: "God Only Knows [ VII ].png" },
  { title: "Bachata Ballad", file: "Bachata Ballad.web.m4a", art: "Bachata Ballad.png" },
  { title: "Bargain in Ruins [ I ] 110 BPM", file: "Bargain in Ruins [ I ] 110 BPM.web.m4a", art: "Bargain in Ruins [ I ] 110 BPM.png" },
  { title: "Bargain in Ruins [ I ]", file: "Bargain in Ruins [ I ].web.m4a", art: "Bargain in Ruins [ I ].png" },
  { title: "Bargain in Ruins [ II ]", file: "Bargain in Ruins [ II ].web.m4a", art: "Bargain in Ruins [ II ].png" },
  { title: "Bargain in Ruins [ III ]", file: "Bargain in Ruins [ III ].web.m4a", art: "Bargain in Ruins [ III ].png" },
  { title: "Midnight in Blue [ II ]", file: "Midnight in Blue [ II ].web.m4a", art: "Midnight in Blue [ II ].png" },
  { title: "Midnight in Blue [ III ]", file: "Midnight in Blue [ III ].web.m4a", art: "Midnight in Blue [ III ].png" },
  { title: "Midnight in Blue [ IV ]", file: "Midnight in Blue [ IV ].web.m4a", art: "Midnight in Blue [ IV ].png" },
  { title: "Warm Echoes [ I ]", file: "Warm Echoes [ I ].web.m4a", art: "Warm Echoes [ I ].png" },
  { title: "Warm Echoes [ II ]", file: "Warm Echoes [ II ].web.m4a", art: "Warm Echoes [ II ].png" },
  { title: "Warm Static [ I ]", file: "Warm Static [ I ].web.m4a", art: "Warm Static [ I ].png" },
  { title: "Warm Static [ II ]", file: "Warm Static [ II ].web.m4a", art: "Warm Static [ II ].png" },
  { title: "House Ballad [ I ]", file: "House Ballad [ I ].web.m4a", art: "House Ballad [ I ].png" },
  { title: "House Ballad [ II ]", file: "House Ballad [ II ].web.m4a", art: "House Ballad [ II ].png" },
  { title: "Midnight in Blue [ I ]", file: "Midnight in Blue [ I ].web.m4a", art: "Midnight in Blue [ I ].png" },
];
...
if (!diesApri || diesApri.kind !== 'audio') {
  throw new Error('Dies Apri audio album is missing from the generated catalog');
}
diesApri.tracks = DIES_APRI_REPLACEMENT_TRACKS.map(track => ({ ...track }));
if (diesApri.tracks.length !== 24 || new Set(diesApri.tracks.map(track => track.file)).size !== 24) {
  throw new Error('Dies Apri replacement track list must contain exactly 24 unique tracks');
}
...
if (audioCount !== 245) throw new Error(`Audio total ${audioCount}, expected 245`);
if (videoCount !== 9) throw new Error(`Video total ${videoCount}, expected 9`);
if (artworkCount !== 245) throw new Error(`Artwork total ${artworkCount}, expected 245`);
